...
public class DietPanel extends JPanel {
  ...
  public DietPanel(BuildUI parentFrame) {
    ...
    String[] Diet = {" ", "DASH Diet", "Keto Diet", "Low Carb Diet", "Paleo Diet", "Regular Diet",
    ...
    String[] Cuisines = {" ", "American", "Chinese", "Greek", "Indian", "Italian", "Japanese",
    ...
    String[] allergyFoods = {"None", "Eggs", "Fish", "Gluten", "Lactose", "Mango", "Milk", "Peach",
        "Peanuts", "Sesame", "Shellfish", "Soy", "Tree nuts", "Wheat"};
    ...
    String[] dislikeFoods = {"None", "Almond", "Apple", "Asparagus", "Avocado", "Basil", "Beef",
        "Beets", "Beans", "Bell Pepper", "Broccoli",
        "Brussels Sprouts", "Carrots", "Cauliflower", "Celery", "Cheese", "Chicken", "Chickpea",
        "Chocolate", "Cilantro",
        "Cinnamon", "Coconut", "Corn", "Crab", "Duck", "Eggs", "Garlic", "Ginger", "Green Beans",
        "Ham", "Honey", "Kale",
        "Kiwi", "Lamb", "Lemon", "Lentils", "Lettuce", "Mango", "Mayonnaise", "Milk", "Mushrooms",
        "Oatmeal", "Olives",
        "Onions", "Papaya", "Parsley", "Peanuts", "Peas", "Pickles", "Pineapple", "Pork",
        "Potatoes", "Pumpkins", "Radish", "Raw Fish",
        "Salmon", "Sausages", "Scallops", "Seaweed", "Shellfish", "Shrimp", "Soybeans", "Spinach",
        "Sweet Potatoes",
    ...
    generateButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (dietType == null || dietType == " ") {
          JOptionPane.showMessageDialog(null, "Please select a diet type to proceed.", "Warning",
        ...
        if (cuisine == null || cuisine == " ") {
          JOptionPane.showMessageDialog(null, "Please select a preferred cuisine to proceed.",
        ...
        if (calorieTextField.getText().isEmpty()) {
          JOptionPane.showMessageDialog(null,
              "Calorie value cannot be empty. Please enter a value.", "Warning",
              JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }
        ...
        if (calorieTextField.getText().contains(".")) {
          JOptionPane.showMessageDialog(null, "Please enter an integer for calories.", "Warning",
              JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }
        ...
        if (calories < 300 || calories > 5000) {
          JOptionPane.showMessageDialog(null, "Calorie value is out of range. Please recheck.",
              "Warning", JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }
        ...
        if (mealTimeString == null || mealTimeString == " ") {
          JOptionPane.showMessageDialog(null, "Please select a meal frequency to proceed.",
              "Warning", JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }
        ...
        if (snackTimeString == null || snackTimeString == " ") {
          JOptionPane.showMessageDialog(null, "Please select a snack frequency to proceed.",
              "Warning", JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }
        ...
        if (mealTimeString == "0" && snackTimeString == "0") {
          JOptionPane.showMessageDialog(null,
              "Meal and snack times cannot both be zero. Please recheck.", "Warning",
              JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }
        ...
        if (allergyFoodList.getSelectedValuesList().isEmpty() == true) {
          JOptionPane.showMessageDialog(null,
              "Please select an option for Food Allergy/Intolerence.\nIf you don't have any, please select \"None\".",
              "Warning", JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }

        if (allergyFoodList.getSelectedValuesList().contains("None")
            && allergyFoodList.getSelectedValuesList().size() > 1) {
          JOptionPane.showMessageDialog(null,
              "Selection conflictation in Food Allergy/Intolerence.\nPlease check if you selected \"None\" as well as others.",
              "Warning", JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }
        ...
        if (dislikeFoodList.getSelectedValuesList().isEmpty() == true) {
          JOptionPane.showMessageDialog(null,
              "Please select an option for Disliked Foods.\nIf you don't have any, please select \"None\".",
              "Warning", JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }

        if (dislikeFoodList.getSelectedValuesList().contains("None")
            && dislikeFoodList.getSelectedValuesList().size() > 1) {
          JOptionPane.showMessageDialog(null,
              "Selection conflictation in Disliked Foods.\nPlease check if you selected \"None\" as well as others.",
              "Warning", JOptionPane.WARNING_MESSAGE);
          generateButton.setEnabled(true);
          return;
        }

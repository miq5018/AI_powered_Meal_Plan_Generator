...
/**
 * Represents the diet preferences of a user, including diet type, cuisine preference, daily calorie
 * limit, meal and snack times, as well as selected items for allergies/intolererence and dislikes.
 */
public class DietPreferences {
   ...
   */
  public DietPreferences(String dietType, String cuisine, int calories, String mealTimeString,
      String snackTimeString,
   ...
   *
   * @param allergySelectedItems The items that the user is allergic to or is intolerent with to
   *                             set
   */
